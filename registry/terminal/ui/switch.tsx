...
function Switch({
  ...
  return (
    <SwitchPrimitive.Root
      className={cn(
        "peer group/switch inline-flex shrink-0 items-center rounded-none border border-line bg-panel-sunken p-px outline-none transition",
    ...
    >
      <SwitchPrimitive.Thumb
        className={cn(
          "pointer-events-none block rounded-none bg-phosphor-dim transition duration-150 ease-terminal",
