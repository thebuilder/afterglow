...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <input
      className={cn(
        "h-9 w-full min-w-0 rounded-none border border-input bg-panel-sunken px-3 py-1 font-mono text-base text-phosphor-bright caret-phosphor-bright outline-none transition-[border-color,box-shadow] duration-150 ease-terminal md:text-sm",
