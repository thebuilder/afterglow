...
function Kbd({
  ...
  return (
    <kbd
      className={cn(
        "pointer-events-none inline-flex h-[1.375rem] w-fit min-w-[1.375rem] select-none items-center justify-center gap-1 rounded-none border border-line border-b-line-strong bg-secondary px-1.5 pt-[1.5px] font-medium font-mono text-1xs text-phosphor-bright leading-none shadow-[0_2px_0_rgb(0_0_0/0.45)]",
