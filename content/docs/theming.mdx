...
The theme includes `green`, `orange`, `yellow`, `cyan`, `magenta`, and `grey`. Green is the default. Each preset remaps the phosphor ramp, panels, borders, focus rings, and semantic controls. Signal and status colours keep their existing meanings.
...
<ThemeProvider
  ...
  themes={["green", "orange", "yellow", "cyan", "magenta", "grey"]}
>
  {children}
</ThemeProvider>
```
